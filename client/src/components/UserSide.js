                        ...
                        <MDBCard>
                            <div className="rounded-top text-white d-flex flex-row" style={{ backgroundColor: '#000', height: '200px' }}>
                                <div className="ms-4 mt-5 d-flex flex-column" style={{ width: '150px' }}>
                                    <MDBCardImage src="https://cdn.iconscout.com/icon/free/png-512/free-profile-1439375-1214445.png?f=avif&w=256"
                            ...
                            <MDBCardBody className="text-black p-4">
                                <div className="mb-5">
                                    ...
                                    <div className="p-4" style={{ backgroundColor: '#f8f9fa' }}>
                                        <MDBCardText className="font-italic mb-1">Contact: 8765980925</MDBCardText>
                                        <MDBCardText className="font-italic mb-1">Blood Group: O+ve</MDBCardText>
                                ...
                                <MDBRow>
                                    <MDBCol className="mb-2">
                                        ...
                                        <h6>No More Certificates found</h6>
                                    </MDBCol>
                                </MDBRow>
